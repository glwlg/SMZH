...
| --- | --- | --- | --- | --- | --- | --- |
| Hyoshi Action Track 2 | `Assets/Resources/Audio/BGM/hyoshi_action_track_2.ogg` | OpenGameArt: https://opengameart.org/content/hyoshi-action-track-2 | Tozan | CC0 | 战斗 BGM | 下载文件名：`Hyohiaction2.ogg`。 |
